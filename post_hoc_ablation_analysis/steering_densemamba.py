...
Based on Griffin repository: https://github.com/hsj576/GRIFFIN

Griffin: Mixing Gated Linear Recurrences with Local Attention for Efficient Language Models
Paper: https://arxiv.org/pdf/2402.19427.pdf

This script performs:
1. Interpretability analysis on Griffin models
2. Identifies critical layers and cluster neurons
3. Tests universal steering across Griffin variants
