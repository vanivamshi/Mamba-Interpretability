...
def run_delta_intervention_analysis(model, tokenizer, top_neurons, layer_idx, relations_dict, baseline_model_name="gpt2"):
    ...
    plt.savefig("images/delta_intervention_suppression.png", dpi=300, bbox_inches='tight')
    print("✅ Saved suppression plot to images/delta_intervention_suppression.png")
    ...
    # Save the plot to images folder
    plt.savefig("images/delta_intervention_amplification.png", dpi=300, bbox_inches='tight')
    print("✅ Saved amplification plot to images/delta_intervention_amplification.png")
    # plt.show()  # Not needed with non-interactive backend
