    ...
    for dim in test_dims:
        ...
        try:
            ...
            if successful_analyses > 0:
                ...
                plt.xlabel('Target Layer Activation')
                plt.ylabel('Source Layer Activation')
                plt.title(f'Cross-Layer Causal Influence Matrix (Dim {dim})')
                ...
                cbar.set_label('Target Neuron Activation')
