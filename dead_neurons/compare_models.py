...
def analyze_model_dead_neurons(model_name, texts, threshold=0.1, max_layers=None):
...
def main():
    ...
    print(f"Testing {len(models)} models with threshold = 0.1")
    
    all_results = []
    
    for model_name in models:
        try:
            result = analyze_model_dead_neurons(model_name, texts, threshold=0.1, max_layers=12)
